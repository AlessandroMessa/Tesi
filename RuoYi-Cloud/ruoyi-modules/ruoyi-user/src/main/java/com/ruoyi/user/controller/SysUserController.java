...
import com.ruoyi.common.core.utils.poi.template.ExcelTemplateBuilder;
...
import com.ruoyi.user.service.ISysUserService;
...
public class SysUserController extends BaseController
{
    ...
    public void export(HttpServletResponse response, SysUser user)
    {
        ...
        util.exportExcel(response, list, "用户数据", "Titolo");
    }
    ...
    {
        ExcelUtil<SysUser> util = new ExcelUtil<SysUser>(SysUser.class);
        List<SysUser> userList = util.importExcel(file.getInputStream(), "Sheet1", 1);
    ...
    {
        ExcelTemplateBuilder<SysUser> builder = new ExcelTemplateBuilder<>(SysUser.class);
        builder.exportTemplate(response, "Sheet1", "用户数据");
